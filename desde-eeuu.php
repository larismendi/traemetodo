        ...
        <td align="center" bgcolor="#FFFFFF">
            <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="right" valign="top"><span class="Estilo13"><span class="Estilo14">Traemetodo.com </span>/COMO ENVIAR </span>
                    </td>
...
<div bgcolor="#FFC929" style="display:none">
    ...
    <form name="form1" id="form1" class="form shadowed-all" style="margin:0 auto;" method="post" action="">
        ...
        <input name="pais" type="text" id="pais" placeholder="Ingrese su país" size="43" maxlength="40" class="required" value=""/>
