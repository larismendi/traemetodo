	  ...
	  <tr>
	    ...
	    <td align="center" bgcolor="#FFFFFF"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
	      ...
	      <tr>
	        ...
	        <td align="right" valign="top"><span class="Estilo13"><span class="Estilo14">Traemetodo.com </span>/EQUIPOS ELECTRÓNICOS </span></td>
          ...
          <table width="960" border="0" align="center" cellpadding="0" cellspacing="10">
            ...
            <tr>
              ...
              <td width="253" align="center" valign="middle"><img src="img/electrod.jpg" width="253" height="450"></td>

              <td width="455" align="center" valign="top" bgcolor="#FFFFFF"><table width="415" height="31" border="0" cellpadding="0" cellspacing="0">

                <tr>

                  <td width="415"><p align="justify" class="Estilo20">Si necesitas equipos de  computación, equipos electrónicos, televisores, juegos interactivos, equipos  electrodomésticos, auxiliares de cocina, entre otros nosotros se lo cotizamos,  y si&nbsp; usted lo necesita se los Hacemos llegar a la puerta de su casa u  oficina. </p>

                    <p align="justify" class="Estilo20"><br>

                  Con solo llamarnos o escribirnos a nuestro E-mail, que aparecen en la página y  nos especificas lo que necesites.</p></td>
                ...
                <tr>
	              ...
	              <td align="center" valign="top"><a href="#form1" class="inline cboxElement boton" target="_self"><span class="negro">COTIZACIÓN DE</span><span class="amarillo">EQUIPOS ELECTRÓNICOS</span></a></td>
                ...
                <tr>
                  ...
                  <td><SCRIPT charset="utf-8" type="text/javascript" src="http://ws-na.amazon-adsystem.com/widgets/q?rt=tf_cw&ServiceVersion=20070822&MarketPlace=US&ID=V20070822%2FUS%2Fwidgetsamazon-20%2F8010%2Fc0ff9052-b77d-435f-a74f-5ab6d0846b49&Operation=GetScriptTemplate"> </SCRIPT> <NOSCRIPT><A HREF="http://ws-na.amazon-adsystem.com/widgets/q?rt=tf_cw&ServiceVersion=20070822&MarketPlace=US&ID=V20070822%2FUS%2Fwidgetsamazon-20%2F8010%2Fc0ff9052-b77d-435f-a74f-5ab6d0846b49&Operation=NoScript">Amazon.com Widgets</A></NOSCRIPT></td>

                </tr>

              </table>

              <p align="justify" class="Estilo18">&nbsp;</p>                <p align="justify" class="Estilo18">&nbsp;</p></td>
              ...
              <td width="212" valign="top" bgcolor="#FFFFFF"><script charset="utf-8" type="text/javascript">
				...
				amzn_assoc_default_search_key = "TV";
	    ...
	    <td align="center" bgcolor="#FFFFFF">
	    	...
	    	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	          	...
	          	<tr>
		            ...
		            <td align="center" valign="top" bgcolor="#FFC929">&nbsp;
	  ...
	  <tr>
	    ...
	    <td align="center" bgcolor="#FFFFFF"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
	      ...
	      <tr>
	        ...
	        <td align="center" valign="top"><img src="marcaselectro.jpg" width="960" height="112"></td>
...
<div bgcolor="#FFC929" style="display:none">
	...
	<form name="form1" id="form1" class="form shadowed-all" method="post" action="" style="margin:0 auto;">
	    ...
	    <p>COTIZACIÓN DE EQUIPOS ELECTRÓNICOS</p>

	    <label for="nombre"><strong>Nombre y Apellido:</strong></label>

	    <input name="nombre" type="text" id="nombre" placeholder="Ingrese nombre y apellido" size="43" class="required" value="" />

	    <label for="email"><strong>Email:</strong></label>

	    <input name="email" type="text" id="email" placeholder="Ingrese Email" size="43" class="required email" value="" />
	    ...
	    <label for="descripcion"><strong>Descripción de solicitud:</strong></label>

	    <textarea name="descripcion" id="descripcion" class="required" placeholder="Ingrese la descripción de solicitud"></textarea>
...
$(function(){
	...
	$('#form1').validate({
	    ...
	    submitHandler: function(form){
	      ...
	      $.post("equipos_success.php", $("#form1").serialize(), function(data){
