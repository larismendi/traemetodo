...
<script src="../../js/pagos/pagos.functions.js" type="text/javascript"></script>
...
<div id="contenedor">
    ...
    <div id="cuerpo">
        ...
        <div id="principal">
        	<br />
            <div id="titulo_form"><a href="../pagos" class="link-tenue">Inicio</a> - Pagos</div>
            <br />
            <div id="contenido">
            	<br />
                      ...
                      <form action="javascript: ConsultaDatos();" id="frm_buscar" name="frm_buscar">                      
                          ...
                          <span>
                              <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                                  <option value="id_pago">Id</option>
