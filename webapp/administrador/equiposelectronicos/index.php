...
<script src="../../js/equiposelectronicos/equiposelectronicos.functions.js" type="text/javascript"></script>
...
<div id="contenedor">
    ...
    <div id="cuerpo">
        ...
        <div id="principal">
        	<br />
            <div id="titulo_form"><a href="../equiposelectronicos" class="link-tenue">Inicio</a> - Equipos Electrónicos</div>
            <br />
            <div id="contenido">
            	<br />
                      ...
                      <form action="javascript: ConsultaDatos();" id="frm_buscar" name="frm_buscar">                      
                          ...
                          <span>
                              <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                                  <option value="id_equipoelectronico">Id</option>
