...
<script src="../../js/registros/registros.functions.js" type="text/javascript"></script>
...
<div id="contenedor">
    ...
    <div id="cuerpo">
        ...
        <div id="principal">
        	<br />
            <div id="titulo_form"><a href="../registros" class="link-tenue">Inicio</a> - Registros</div>
            <br />
            <div id="contenido">
            	<br />
                      ...
                      <form action="javascript: ConsultaDatos();" id="frm_buscar" name="frm_buscar">                      
                          ...
                          <span>
                              <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                                  <option value="id_registro">Id</option>
