...
if(isset($_POST['nombre']) && isset($_POST['email'])){
	...
	if($obj->insertar(array($nombre,$email,$telefono,$tipo_emb,$marca,$modelo,$anio,$vin,$descripcion))==true){
...
<form id="frmNuevo" name="frmNuevo" class="form" action="nuevo.php" method="post" enctype="multipart/form-data">
	...
	<p>
	    ...
	    <input name="tipo_emb" type="text" id="tipo_emb" maxlength="50" class="text required" value="" />
	    </label>
    </p>
	<p>
	    <label>Marca:<br />
