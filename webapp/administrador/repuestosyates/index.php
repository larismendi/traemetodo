...
<script src="../../js/repuestosyates/repuestosyates.functions.js" type="text/javascript"></script>
...
<div id="contenedor">
    ...
    <div id="cuerpo">
        ...
        <div id="principal">
        	<br />
            <div id="titulo_form"><a href="../repuestosyates" class="link-tenue">Inicio</a> - Repuestos Yates</div>
            <br />
            <div id="contenido">
            	<br />
                      ...
                      <form action="javascript: ConsultaDatos();" id="frm_buscar" name="frm_buscar">                      
                          ...
                          <span>
                              <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                                  <option value="id_repuestoyate">Id</option>
                                  <option value="nombre">Nombre</option>
                                  <option value="email">Email</option>
                                  <option value="telefono">Teléfono</option>
                                  <option value="tipo_emb">Tipo de embarcación</option>
