...
require_once('../../controlador/repuestosyates/repuestosyates.php');
?>
...
?>	
      <tr id="fila-<?php echo $consulta['id_repuestoyate'] ?>" class="somb">
      	<td><b><?=$consulta['id_repuestoyate']?></b></td>
        <td><?=strtoupper($consulta['nombre'])?></td>
        <td><?=($consulta['email'])?></td>
        <td><?=strtoupper($consulta['telefono'])?></td>
        <td><?=strtoupper($consulta['tipo_emb'])?></td>
        <td><?=strtoupper($consulta['marca'])?></td>
        <td><?=strtoupper($consulta['modelo'])?></td>
        <td><?=strtoupper($consulta['anio'])?></td>
        <td><?=strtoupper($consulta['vin'])?></td>
        <td><?=$consulta['habilitado']==1?'SI':'NO'?></td>
        <td><?=$consulta['created_at'] ?></td>
        <td><span class="modi"><a href="actualizar.php?id=<?=$consulta['id_repuestoyate'] ?>"><img src="../../img/database_edit.png" title="Editar" alt="Editar" border="0" /></a></span></td>
        <td><span class="dele"><a onClick="EliminarDato(<?=$consulta['id_repuestoyate'] ?>); return false" href="eliminar.php?id=<?=$consulta['id_repuestoyate'] ?>"><img src="../../img/delete.png" title="Eliminar" alt="Eliminar" border="0" /></a></span></td>
      </tr>
	<?php
	endforeach;
  ?>
