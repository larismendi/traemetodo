...
<title>Repuestos para yates y lanchas de todas las marcas</title>
...
.form label.error { 0color: red; margin:-5px 0 5px 0;
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="right" valign="top"><span class="Estilo13"><span class="Estilo14">Traemetodo.com </span>/REPUESTOS YATES Y LANCHAS </span></td>
      ...
      <tr>
        ...
        <td width="519" align="right" valign="top">&nbsp;</td>
      ...
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="10">
        ...
        <tr>
          ...
          <td width="253" align="center" valign="middle"><img src="img/yates.jpg" width="253" height="450"></td>

          <td width="455" align="center" valign="top" bgcolor="#FFFFFF"><table width="415" height="31" border="0" cellpadding="0" cellspacing="0">

            <tr>

              <td width="415" valign="top"><p align="justify" class="Estilo21">Le ubicamos sus compras de partes  mecánicas, eléctricas y accesorios, <strong>PARA YATES, EMBARCACIONES PEQUEÑAS</strong> o para  cualquier tipo de embarcación marina.<br>

                <br>

                Lo que necesite se los ubicamos en los EEUU  o cualquier parte del mundo y se lo hacemos llegar a la puerta de su casa u  oficina.</p>

                <p align="justify" class="Estilo23">&nbsp;</p>

              <p align="justify" class="Estilo23">&nbsp;</p></td>
            ...
            <tr>
              ...
              <td align="center" valign="top"><a href="#form1" class="inline cboxElement boton" target="_self"><span class="negro">COTIZACIÓN</span><span class="amarillo"> DE REPUESTOS</span></a></td>
            ...
            <tr>
              ...
              <td valign="top"><SCRIPT charset="utf-8" type="text/javascript" src="http://ws-na.amazon-adsystem.com/widgets/q?rt=tf_cw&ServiceVersion=20070822&MarketPlace=US&ID=V20070822%2FUS%2Fwidgetsamazon-20%2F8010%2F3086eb4b-9868-4978-8697-fd988672ea16&Operation=GetScriptTemplate"> </SCRIPT> <NOSCRIPT><A HREF="http://ws-na.amazon-adsystem.com/widgets/q?rt=tf_cw&ServiceVersion=20070822&MarketPlace=US&ID=V20070822%2FUS%2Fwidgetsamazon-20%2F8010%2F3086eb4b-9868-4978-8697-fd988672ea16&Operation=NoScript">Amazon.com Widgets</A></NOSCRIPT></td>
        ...
        <td width="212" valign="top" bgcolor="#FFFFFF">
          ...
          <script charset="utf-8" type="text/javascript">
			...
			amzn_assoc_default_search_key = "boats parts";
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center" valign="top"><img src="marcayates.jpg" width="960" height="112"></td>
    ...
    <td align="center" bgcolor="#333333"><table width="960" border="0" cellspacing="10" cellpadding="0">
      ...
      <tr>
        ...
        <td align="left" valign="top"><div align="left"><strong>Nuestro Horario de atención es de:</strong><br>
          ...
          <strong>E-mail:</strong> <a href="mailto:info@traemetodo">info@traemetodo.com</a></div></td>
...
$(function(){
  ...
  $(".inline").colorbox({inline:true, width:"50%"});
    ...
    submitHandler: function(form){
      ...
      $.post("yates_success.php", $("#form1").serialize(), function(data){
