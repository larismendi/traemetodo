...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Por favor, introduzca una URL válida. Por ejemplo: http://pagina.com",
		caractesp: "Por favor, no se admiten caracteres especiales.",
		telf: "Por favor, introduzca un teléfono válido. Por ejemplo (0212)-5555555 or 5555555 or ó +584125555555.",		
	...
	methods: {
		...
		caractesp: function(value, element) {
			return this.optional(element) || /^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ.,:?"'\(\)\+\-\¿\#\!\¡\%\&\$\=\°\@\/ ]+$/.test(value);
			/*var tt = true;
			if(/^[\\\/]+$/.test(value)){tt=false}
			return this.optional(element) || tt;*/
		},
		
		telf: function(value, element) {
			return this.optional(element) || /^[0-9]{4}[0-9]{7}$/.test(value) || /^[0-9]{7}$/.test(value) || /^[(]{1}[0-9]{4}[)]{1}[-]{0,1}[0-9]{7}$/.test(value) || /^[1-9]{3}[0-9]{7}$/.test(value) || /^[+]{1}[0-9]{12,15}$/.test(value);
		},
